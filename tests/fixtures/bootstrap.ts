...
const catalog: CatalogItem[] = [
  ...
  {
    ...catalogItem(25, 'Pikachu', 1, 'kanto', ['electric']),
    id: 'form-0025-party-hat-2017',
    formName: 'Pikachu with Party Hat (2017)',
    formKey: 'party-hat-2017',
    isDefault: false,
    variantKind: 'costume',
    collectorGroupId: 'pikachu-costumes',
    costumeFamily: 'pikachu-event-costumes',
    formSortOrder: 300,
    rules: {
      normal: 'released',
      shiny: 'released',
